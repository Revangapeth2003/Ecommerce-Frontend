...
const Navbar = () => {
  return (
    <nav className="bg-white shadow-md">
      <div className="container mx-1 px-1 md:px-16 lg:px-24 py-4 flex justify-around items-center">
        ...
        <form className="flex items-center relative">
          <input
            ...
            className="border sm:hidden  rounded-lg text-gray-100 py-2 px-3 p-2 lg:w-72 bg-gray-700  border-gray-400 relative "
          />
